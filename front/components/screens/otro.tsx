...
export default function Otro({
  ...
  const [selectedEvent, setSelectedEvent] = useState<OtroEvent | null>(null);
  const [events, setEvents] = useState<OtroEvent[]>([]);
  ...
  useEffect(() => {
    const loadEvents = async () => {
      ...
      try {
        ...
        const mappedEvents: OtroEvent[] = eventos.map((e: any) => {
  ...
  const handleEventClick = (event: OtroEvent) => {
      ...
      <MobileFrame>
        <div className="vaccines-container">
          ...
          <div className="vaccine-form-icon-wrapper">
            <Image src={otroIcon} alt="Otro" width={84} height={84} />
          </div>

          <div className="vaccine-form-container">
            <div className="vaccine-form-field">
              <label className="vaccine-form-label">Tipo de evento</label>
              <Input
                type="text"
                placeholder="Ej: Otro evento, etc."
      ...
      <div className="vaccines-container">
        <div className="vaccines-header">
          <div className="vaccines-header-left">
            ...
            <h1 className="vaccines-title">Otro</h1>
          </div>
        ...
        <div className="vaccines-content">
          ...
          <div className="vaccines-info-banner">
            ...
            <span className="vaccines-info-text">Información sobre otros eventos</span>
          </div>
          <div className="vaccines-header-line">
            <Image src={lineSvg} alt="Line separator" width={336} height={2} />
          </div>
