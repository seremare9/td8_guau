...
export default function Medicina({
  ...
  const [selectedEvent, setSelectedEvent] = useState<MedicinaEvent | null>(null);
  const [events, setEvents] = useState<MedicinaEvent[]>([]);
  ...
  useEffect(() => {
    const loadEvents = async () => {
      ...
      try {
        ...
        const mappedEvents: MedicinaEvent[] = eventos.map((e: any) => {
      ...
      <MobileFrame>
        <div className="vaccines-container">
          ...
          <div className="vaccine-form-icon-wrapper">
            <Image src={medicinaIcon} alt="Medicina" width={84} height={84} />
          </div>

          <div className="vaccine-form-container">
            <div className="vaccine-form-field">
              <label className="vaccine-form-label">Tipo de medicina</label>
              <Input
                type="text"
                placeholder="Ej: Antibiótico, Analgésico, etc."
      ...
      <div className="vaccines-container">
        <div className="vaccines-header">
          <div className="vaccines-header-left">
            ...
            <h1 className="vaccines-title">Medicina</h1>
          </div>
        ...
        <div className="vaccines-content">
          ...
          <div className="vaccines-info-banner">
            ...
            <span className="vaccines-info-text">Información sobre medicina</span>
          </div>
          <div className="vaccines-header-line">
            <Image src={lineSvg} alt="Line separator" width={336} height={2} />
          </div>
