...
export default function Veterinario({
  ...
  const [selectedEvent, setSelectedEvent] = useState<VeterinarioEvent | null>(null);
  const [events, setEvents] = useState<VeterinarioEvent[]>([]);
  ...
  const handleEventClick = (event: VeterinarioEvent) => {
  ...
  const eventsByYear = filteredEvents.reduce((acc, event) => {
    ...
    acc[year].push(event);
    return acc;
  }, {} as { [year: number]: VeterinarioEvent[] });
      ...
      <MobileFrame>
        <div className="vaccines-container">
          ...
          <div className="vaccine-form-icon-wrapper">
            <Image src={veterinarioIcon} alt="Visita al veterinario" width={84} height={84} />
          </div>

          <div className="vaccine-form-container">
            <div className="vaccine-form-field">
              <label className="vaccine-form-label">Tipo de visita</label>
              <Input
                type="text"
                placeholder="Ej: Consulta, Control, etc."
      ...
      <div className="vaccines-container">
        <div className="vaccines-header">
          <div className="vaccines-header-left">
            ...
            <h1 className="vaccines-title">Visita al veterinario</h1>
          </div>
        ...
        <div className="vaccines-content">
          ...
          <div className="vaccines-info-banner">
            ...
            <span className="vaccines-info-text">Información sobre visitas al veterinario</span>
          </div>
          <div className="vaccines-header-line">
            <Image src={lineSvg} alt="Line separator" width={336} height={2} />
          </div>
